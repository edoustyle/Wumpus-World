...
public class Versao1 {
    public static int tamanho,x,y,choice,quantidadeWumpos,quantidadePocos,morte=0,pegouOouro=0,sobreviveu=0,queda=0,terror=0,matouobixo2=0,inicio=0,agente=0,rodadas=0;
    public static Posicao matPosicao[][];
    public static String testetipo, fantasma="vivo",sentido="",estado, M[][];
    ...
    public static void criarsentido(){
        ...
        for (int i = 0; i < tamanho; i++) {
            for (int j = 0; j < tamanho; j++) {
                ...
                if (j<tamanho-1) {
                    if (matPosicao[i][j+1].getAmbiente().equals("monstro")||matPosicao[i][j+1].getAmbiente().equals("ouro|monstro")) temBixo=true;
                    if (matPosicao[i][j+1].getAmbiente().equals("poço")) {tempoco=true;}
                    if (matPosicao[i][j+1].getAmbiente().equals("ouro|monstro")||matPosicao[i][j+1].getAmbiente().equals("ouro")) temouro=true;
                }
                if (j>0) {
                    if(matPosicao[i][j-1].getAmbiente().equals("monstro")||matPosicao[i][j-1].getAmbiente().equals("ouro|monstro"))temBixo=true;
                    if(matPosicao[i][j-1].getAmbiente().equals("poço")){tempoco=true;}
                ...
                if (i<tamanho-1) {
                    if(matPosicao[i+1][j].getAmbiente().equals("monstro")||matPosicao[i+1][j].getAmbiente().equals("ouro|monstro"))temBixo=true;
                    if(matPosicao[i+1][j].getAmbiente().equals("poço")){tempoco=true;}
                    if (matPosicao[i+1][j].getAmbiente().equals("ouro|monstro")||matPosicao[i+1][j].getAmbiente().equals("ouro")) temouro=true;
                }
                if (i>0) {
                    if(matPosicao[i-1][j].getAmbiente().equals("monstro")||matPosicao[i-1][j].getAmbiente().equals("ouro|monstro")) temBixo=true;
                    if(matPosicao[i-1][j].getAmbiente().equals("poço"))tempoco=true;
                ...
                if (temBixo&&tempoco) matPosicao[i][j].setSentido("fedor|brisa");
                else if(tempoco)matPosicao[i][j].setSentido("brisa");
                else if(temBixo)matPosicao[i][j].setSentido("fedor");
                else if (temBixo&&temouro&&tempoco) matPosicao[i][j].setSentido("brilho|fedor|brisa");
                else if (temBixo&&temouro) matPosicao[i][j].setSentido("brilho|fedor");
                else if (tempoco&&temouro) matPosicao[i][j].setSentido("brilho|brisa");
                else if (matPosicao[i][j].getAmbiente().equals("ouro")||matPosicao[i][j].getAmbiente().equals("ouro|monstro")) matPosicao[i][j].setSentido("brilho");
                else matPosicao[i][j].setSentido("seguro");
        ...
        while (rodadas<3) {
            ...
            while (jogo) {
                ...
                if (indo=='N') {
                    ...
                    if (estado.equals("Vivo")) System.out.println("Jogo continua");
                }
                if (indo=='S') {
                    M[t][q]=" ";
                    t=t+1;
