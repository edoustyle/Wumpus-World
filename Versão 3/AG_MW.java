...
public class AG_MW {
    ...
    private static final double TAXA_MUTACAO = 0.8;
    ...
    public Populacao evolverPopulacao(Populacao populacao, ListaPopulacao ListaP) {
        ...
        while (indiceInicio < novaPopulacao.getTamanhoPopulacao()) {
            Individuo pai1 = selecaoRank(populacao);
            Individuo pai2 = selecaoRank(populacao);
            //System.out.println("Pai 1 fitness: "+pai1.getFitness()+" genes: "+pai1);
            //System.out.println("Pai 2 fitness: "+pai2.getFitness()+" genes: "+pai2);
